...
function lucideIcon(name, size = 20) {
  // Minimal Lucide-style SVG paths for the mobile shell.
  const paths = {
    ...
    images: '<path d="M18 22H4a2 2 0 0 1-2-2V6"/><path d="M22 13.5V6a2 2 0 0 0-2-2H10a2 2 0 0 0-2 2v13.5"/><circle cx="10" cy="7" r="1.5"/><path d="m22 17-4.375-3.5a1 1 0 0 0-1.25 0L13 17l-2.625-2.1a1 1 0 0 0-1.25 0L6 17"/>',
