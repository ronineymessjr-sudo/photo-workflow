...
for (const relative of ['index.html', 'en/index.html', 'ja/index.html', 'ko/index.html', 'workspace.html', 'build-info.json', 'assets/app.css', 'assets/landing.css', 'assets/beta-feedback.css', 'assets/reference-database.json', 'assets/marketing/photoatelier-hero-v1.png', 'assets/marketing/photoatelier-workflow-v1.png', 'assets/demo/references/pose-01.jpg', 'assets/demo/references/pose-12.jpg', 'data/v5-real-data-catalog.json', 'src/app.js', 'src/public-beta.js', 'src/beta-feedback.js', 'src/app-enhancements.js', 'src/legacy-v5-bridge.js', 'src/legacy-resource-workspace.js', 'src/photographer-reference-ui.js', 'src/core/schema.js', 'src/data/photography-rules.js', 'src/pages/system.js', 'src/pages/crew.js', 'src/services/role-workspace.js', 'src/services/project-templates.js', 'src/services/feedback-analytics.js', 'src/v5/application.js', 'src/v5/seeds/equipment-models.js', 'manifest.webmanifest', 'sw.js', 'legacy/index.html']) {
