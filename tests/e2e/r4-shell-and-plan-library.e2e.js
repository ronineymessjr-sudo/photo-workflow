...
async function runChecks(page) {
  ...
  await page.locator('.nav-item[data-tab="calendar"]').click();
  await page.waitForSelector('#tab-calendar.active', { timeout: 5000 });
  await page.waitForTimeout(300);
  ...
  await page.waitForTimeout(300);
  await page.screenshot({ path: path.join(evidenceDir, 'r4-settings-1440.png'), fullPage: false });
