...
const feedbackCopy = {
  ...
  ja: { trigger: 'フィードバック', triggerAria: '利用フィードバックを送信', title: '使いにくかった点を教えてください', privacy: 'プラン、画像、Obsidian の内容は自動添付されません。', close: 'フィードバックを閉じる', task: '何をしようとしていましたか', taskPlaceholder: '例：候補プランを来週の日程に追加する', area: 'どこで起きましたか', friction: 'どこで止まりましたか', frictionPlaceholder: 'やりたかったこと、起きたこと、期待する改善を記入してください', impact: '影響度', submit: '送信する', sending: '送信中…', received: '受け付けました。詳しく教えていただきありがとうございます。', queued: 'オフラインのため端末に保存し、再送待ちにしました。', areas: ['プラン生成', 'リファレンス', '日程と現場', 'LUTと仕上げ', 'データ接続', '画面と操作', 'その他'] },
  ko: { trigger: '피드백', triggerAria: '사용 피드백 보내기', title: '불편한 점을 알려주세요', privacy: '플랜, 이미지, Obsidian 콘텐츠는 자동으로 첨부되지 않습니다.', close: '피드백 창 닫기', task: '무엇을 하려고 했나요', taskPlaceholder: '예: 후보 플랜을 다음 주 일정에 추가하기', area: '어디에서 발생했나요', friction: '어디에서 막혔나요', frictionPlaceholder: '원래 하려던 일, 실제 발생한 일, 원하는 개선을 적어주세요', impact: '영향도', submit: '피드백 보내기', sending: '전송 중…', received: '접수했습니다. 문제를 자세히 알려주셔서 감사합니다.', queued: '오프라인 상태여서 기기에 저장하고 재전송 대기열에 추가했습니다.', areas: ['플랜 생성', '레퍼런스', '일정과 현장', 'LUT와 후보정', '데이터 연결', '화면과 조작', '기타'] },
};
