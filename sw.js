const CACHE = 'photoatelier-v2.5-resource-workspace-2';
const IS_LOCAL = ['127.0.0.1', 'localhost'].includes(self.location.hostname);
const SHELL = [
  ...
  './src/domain.js', './src/storage.js', './src/feishu-sync.js', './src/app-enhancements.js', './src/legacy-v5-bridge.js', './src/legacy-resource-workspace.js', './src/photographer-reference-ui.js', './src/enhancements.css', './src/r4-shell.css', './src/public-feedback-client.js', './src/public-beta.js', './src/beta-feedback.js',
