...
const locales = {
  en: {
    ...
    text: {
      ...
      '摄影生产工作台': 'Photography production workspace', '把灵感变成真正能拍的方案。': 'Turn visual ideas into plans you can actually shoot.',
  ...
  ja: {
    ...
    text: {
      ...
      '摄影生产工作台': '写真制作ワークスペース', '把灵感变成真正能拍的方案。': 'アイデアを、実際に撮れるプランへ。', '开始公开测试': '公開ベータを試す', '了解隐私模式': 'プライバシーモードを見る', '默认保存在你的浏览器，不上传个人图库': 'データは標準でブラウザに保存され、個人ライブラリはアップロードされません。',
  ...
  ko: {
    ...
    text: {
      ...
      '摄影生产工作台': '사진 제작 워크스페이스', '把灵感变成真正能拍的方案。': '아이디어를 실제 촬영 가능한 플랜으로.', '开始公开测试': '공개 베타 시작', '了解隐私模式': '개인정보 모드 보기', '默认保存在你的浏览器，不上传个人图库': '기본적으로 브라우저에 저장되며 개인 라이브러리는 업로드되지 않습니다.',
